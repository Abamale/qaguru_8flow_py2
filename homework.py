...
def print_name_args(name, **kwargs):
    func_name = name.__name__.replace('_', ' ').title()
...
def go_to_companyname_homepage(page_url):
    actual_result = print_name_args(go_to_companyname_homepage, page_url = page_url)
    assert actual_result == "Go To Companyname Homepage [https://companyname.com]"


def find_registration_button_on_login_page(page_url, button_text):
    actual_result = print_name_args(find_registration_button_on_login_page, page_url = page_url, button_text = button_text)
